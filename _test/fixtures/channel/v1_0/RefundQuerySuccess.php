 ...
 * @since 2018年11月13日
 */
class RefundQuerySuccess implements RefundQueryInterface
{
    /**
     *
     * {@inheritDoc}
    ...
    public function execute(Request $Request) : Response
    {
        ...
        $Response->setRefundStatus(Constant::TRADE_REFUND_STATUS_SUCCESS);
        $Response->setRefundPayYmdhis(date('Y-m-d H:i:s'));
        return $Response;
    }
    ...
    {
        return [
            'TEST-REFUND-QUERY-SUCCESS'  => '测试查询退款[成功]',
        ];
    }
}