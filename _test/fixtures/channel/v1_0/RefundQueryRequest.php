 ...
 * @since 2018年11月13日
 */
class RefundQueryRequest implements RefundQueryInterface
{
    /**
     *
     * {@inheritDoc}
    ...
    public function execute(Request $Request) : Response
    {
        ...
        $Response->setRefundStatus(Constant::TRADE_REFUND_STATUS_REQUEST);
        return $Response;
    }
    ...
    {
        return [
            'TEST-REFUND-QUERY-REQUEST'  => '测试查询退款[请求中]',
        ];
    }
}